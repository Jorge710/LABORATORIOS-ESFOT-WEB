...
<div class="row justify-content-center">
    <div class="col-md-5">
        <div class="card">
            <div class="card-header" id="styFormAuth">{{ __('Inicio de sesión') }}</div>
            <script>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="btn btn-primary" type="button" onclick="mostrarContrasena()"><i class="fas fa-low-vision"></i></button>
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
